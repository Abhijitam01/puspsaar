...
const filterCategories = [
  ...
  {
    title: 'Price Range',
    options: ['₹0 - ₹199', '₹200 - ₹499', '₹500 - ₹999', '₹1000 & above'],
  },
  {
    title: 'Brand',
    options: ['DivineKart', 'Bhakti Essentials', 'Patanjali', 'Mangaldeep', 'PurePooja', 'Herbal Essence'],
  },
  {
    title: 'Color',
    options: ['Golden', 'Silver', 'Copper', 'Red', 'Yellow', 'Brown', 'Natural Clay'],
  },
  {
    title: 'Discount',
    options: ['10% or more', '25% or more', '50% or more', '70% or more'],
  },
  {
    title: 'Material',
    options: ['Copper', 'Brass', 'Silver', 'Gold Plated', 'Clay', 'Wood', 'Crystal', 'Steel'],
  },
  {
    title: 'Rating',
    options: [],
