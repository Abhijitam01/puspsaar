        ...
        <div className="carousel-container relative flex flex-col items-center  overflow-hidden">
               {/* Decorative Elements */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-5 right-10 w-80 h-80 bg-red-200/20 dark:bg-purple-500/10 rounded-full blur-2xl"></div>
                    <div className="absolute top-10 left-10 w-80 h-80 bg-red-200/20 dark:bg-orange-500/10 rounded-full blur-3xl"></div>
                </div>
            {/* Left button */}
            <button
                aria-label="Previous"
