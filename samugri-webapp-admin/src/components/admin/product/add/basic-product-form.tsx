    ...
    <FormProvider {...form}>
      <div>
        <div className="space-y-2 mb-8">
          ...
          <p className="text-sm text-muted-foreground">Please fill out the form below to add basic information for the product.</p>
        </div>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold">SKU*</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
