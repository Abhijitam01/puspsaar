    ...
    <div className="min-h-screen bg-background pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground space-y-6 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">7-Day Return Policy</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">How to Initiate a Return</h2>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">Damaged or Defective Items</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8 mb-4">Refund Process</h2>
          <p>
